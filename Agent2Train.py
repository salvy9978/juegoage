...
with open('archivoVariables.json') as file:
    data = json.load(file)
    distanciaUmbralCogerBola = data['distanciaUmbralCogerBola']
    distanciaUmbralCirculoDefensa = data['distanciaUmbralCirculoDefensa']
    distanciaUmbralCirculoAtaque = data['distanciaUmbralCirculoAtaque']
    distanciaEnemigoEstaEnCentro = data['distanciaEnemigoEstaEnCentro']
    distanciaUmbralFrenarParaDefender = data['distanciaUmbralFrenarParaDefender']
    umbralRentaIrPorBola = data['umbralRentaIrPorBola']
    anguloParaIrAlCentro = data['anguloParaIrAlCentro']
    umbralAnguloChoqueConMiCoche = data['umbralAnguloChoqueConMiCoche']
    umbralAnguloChoqueConCocheEnemigo = data['umbralAnguloChoqueConCocheEnemigo']
    penalizacionMetrosPorAngulo = data['penalizacionMetrosPorAngulo']
